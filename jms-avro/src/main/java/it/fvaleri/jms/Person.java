...
public class Person extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 568449165638857647L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Person\",\"namespace\":\"it.fvaleri.jms\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"address\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public static it.fvaleri.jms.Person.Builder newBuilder() {
    return new it.fvaleri.jms.Person.Builder();
  }
   ...
   * @return A new Person RecordBuilder
   */
  public static it.fvaleri.jms.Person.Builder newBuilder(it.fvaleri.jms.Person.Builder other) {
    if (other == null) {
      return new it.fvaleri.jms.Person.Builder();
    } else {
      return new it.fvaleri.jms.Person.Builder(other);
    }
  }
   ...
   * @return A new Person RecordBuilder
   */
  public static it.fvaleri.jms.Person.Builder newBuilder(it.fvaleri.jms.Person other) {
    if (other == null) {
      return new it.fvaleri.jms.Person.Builder();
    } else {
      return new it.fvaleri.jms.Person.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Person>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(it.fvaleri.jms.Person.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(it.fvaleri.jms.Person other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public it.fvaleri.jms.Person.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.fvaleri.jms.Person.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.fvaleri.jms.Person.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.fvaleri.jms.Person.Builder clearAddress() {
      address = null;
